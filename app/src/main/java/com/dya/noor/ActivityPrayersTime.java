...
public class ActivityPrayersTime extends AppCompatActivity {
    ...
    ImageView ic_fajr_alarm, ic_dhuhr_alarm, ic_asr_alarm, ic_maghrib_alarm, ic_isha_alarm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setting.setOnClickListener(v -> {
            Intent SettingIntent = new Intent(ActivityPrayersTime.this, Settings.class);
        ...
        snackbar = Snackbar.make(constraintLayout, "", Snackbar.LENGTH_SHORT);
        ...
        // goriny image
        if (Utils.getBooleanPref("notification_bayani", true)) {

            ic_fajr.setImageResource(R.drawable.ic_notifications_active);
        } else {

            ic_fajr.setImageResource(R.drawable.ic_notifications_off_24);

        }

        if (Utils.getBooleanPref("notification_niwaro", true)) {

            ic_dhuhr.setImageResource(R.drawable.ic_notifications_active);

        } else {

            ic_dhuhr.setImageResource(R.drawable.ic_notifications_off_24);

        }


        if (Utils.getBooleanPref("notification_asr", true)) {
            ic_asr.setImageResource(R.drawable.ic_notifications_active);

        } else {

            ic_asr.setImageResource(R.drawable.ic_notifications_off_24);

        }


                        if (Utils.getBooleanPref("notification_eywara", true)) {

                               ic_maghrib.setImageResource(R.drawable.ic_notifications_active);
                               } else {
     ic_maghrib.setImageResource(R.drawable.ic_notifications_off_24);
        }


        if (Utils.getBooleanPref("notification_esha", true)) {
            ic_isha.setImageResource(R.drawable.ic_notifications_active);
        } else {
            ic_isha.setImageResource(R.drawable.ic_notifications_off_24);
        }


        if (Utils.getBooleanPref("alarm_bayani", true)) {

            ic_fajr_alarm.setImageResource(R.drawable.ic_smartphone);
        } else {

            ic_fajr_alarm.setImageResource(R.drawable.ic_phonelink);

        }
        if (Utils.getBooleanPref("alarm_niwaro", true)) {

            ic_dhuhr_alarm.setImageResource(R.drawable.ic_smartphone);
        } else {

            ic_dhuhr_alarm.setImageResource(R.drawable.ic_phonelink);

        }


        if (Utils.getBooleanPref("alarm_asr", true)) {
            ic_asr_alarm.setImageResource(R.drawable.ic_smartphone);
        } else {

            ic_asr_alarm.setImageResource(R.drawable.ic_phonelink);

        }


        if (Utils.getBooleanPref("alarm_eywara", true)) {

            ic_maghrib_alarm.setImageResource(R.drawable.ic_smartphone);
        } else {

            ic_maghrib_alarm.setImageResource(R.drawable.ic_phonelink);

        }

        if (Utils.getBooleanPref("alarm_esha", true)) {
            ic_isha_alarm.setImageResource(R.drawable.ic_smartphone);
        } else {

            ic_isha_alarm.setImageResource(R.drawable.ic_phonelink);
        ...
        new Thread(() -> {
            while (isActive) {
                ...
                runOnUiThread(() -> {
                    ...
                    int seconds = (int) ((Objects.requireNonNull(next).milli - System.currentTimeMillis()) / 1000);
    ...
    public void AgadariDasteLat() {
        ...
        btnNo.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(ActivityPrayersTime.this, Settings.class);
            startActivity(intent);
            alertDialog.dismiss();
