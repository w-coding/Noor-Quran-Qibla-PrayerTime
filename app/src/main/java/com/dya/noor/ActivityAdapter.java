       ...
       // String itemPosition = itemData.getAyah();
        ...
        holder.activityLayout.setOnClickListener(v -> {
            ...
            switch (activityName){
                ...
                case "ActivityTafsyriTawhydi":
                    // agar filr habww ba bykatewa
                    File file = new File(context.getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS),"QuranTafseer.pdf");
                    if (file.exists()) {
                         intent = new Intent(context,ActivityTafsyriTawhydi.class);
                         context.startActivity(intent);
                    }
