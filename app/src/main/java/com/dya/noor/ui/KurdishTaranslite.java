...
public class KurdishTaranslite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfView.fromAsset("kurdish_transliteration.pdf")
                .defaultPage(pageNumber)
                .onLoad(nbPages -> pdfView.fromAsset("kurdish_transliteration.pdf")
                        .defaultPage(pageNumber)
                        .enableSwipe(true)
