...
public class MainActivity extends AppCompatActivity {
    ...
    LinearLayout linearLayoutGotoSeeting;
...
// Add activities to the list.
        ...
        activities.add(new ActivityItem("FarmwdaView", "فەرمودەکانی پێغەمبەرﷺ", R.drawable.ic_farmwda));
        activities.add(new ActivityItem("ActivityQuranPdf", "قورئانی پیرۆز(کتێب)", R.drawable.ic_quran_icon_new));
        activities.add(new ActivityItem("ActivityTafsyriTawhydi", "تەفسیری تەوحیدیی", R.drawable.ic_quran));
        ...
        activities.add(new ActivityItem("Zakat", "زەکات", R.drawable.ic_zakat));
        ...
        activities.add(new ActivityItem("NameP", "ناوی پێغەمبەران", R.drawable.ic_kaaba_mecca));
        ...
        activities.add(new ActivityItem("Babatyrozh", "نور", R.drawable.noorlogo));
       ...
       */
        ...
        String newValue = (formatted + "").replaceAll("\\s+", "")
                .replaceAll("II", "2");
        String newValue2 = (((((((((((((((((((((((newValue + "")
                ...
                .replaceAll("Muharram", "مُحَرَّم")).replaceAll("Safar", "صَفَر"))
                .replaceAll("RabiI", "رَبِيع ٱلْأَوَّل")).replaceAll(" Rabi٢", "رَبِيع ٱلْآخِر"))
                .replaceAll("JumadaI", "جُمَادَىٰ ٱلْأُولَىٰ")).replaceAll("Jumada٢", "جُمَادَىٰ ٱلْآخِرَة"))
                .replaceAll("Rajab", "رَجَب")).replaceAll("Shaʻban", "شَعْبَان"))
                .replaceAll("Ramadan", "رَمَضَان")).replaceAll("Shawwal", "شَوَّال")
                .replaceAll("Dhuʻl-Qiʻdah", "ذُو ٱلْقَعْدَة")).replaceAll("Dhual-Hijjah", "ذُو ٱلْحِجَّة")));
    ...
    BroadcastReceiver onComplete = new BroadcastReceiver() {
        public void onReceive(Context ctxt, Intent intent) {
            ...
            file12 = new File(context.getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS), "QuranTafseer.pdf");
